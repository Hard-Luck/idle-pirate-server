export const quest = {
  ...
  name: "Setting Sail",
  description:
    "Prepare your ship and crew for your first voyage as a pirate captain.",
  requiredLevel: 1,
  reward: 10,
  difficulty: 1,
  isActive: true,
  numberOfStages: 1,
  successText:
    "You have successfully prepared your ship and crew for the journey. You are now ready to set sail and begin your adventure as a pirate captain. You collect your 10 gold",
};
...
export const questStageOptions = [
  {
    id: "option1",
